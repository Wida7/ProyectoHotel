...
"""
Importamos el documento de texto de donde vamos a extraer los datos, y damos instrucciones sobre este
"""
...
if user == "1":
    ...
    print("Gracias "+nombre+" que tenga buen día, si desea realizar una reserva, ingrese a nuestra sección 'Crear_reserva' para realizar una")
else:
    print("Digito ingresado no valido, intente de nuevo por favor")
